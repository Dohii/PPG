                  ...
                  <div className="project-information">
                    ...
                    <ul>
                      <li>
                        ...
                        <a href="project-details">Some Company</a>
                      </li>
                      <li>
                        <strong>Location:</strong> Sarajevo
                      </li>
                      <li>
                        <strong>Area(m2):</strong> 550,000 m2
                      </li>
                      <li>
                        <strong>Year:</strong> 2019
                      </li>
                      <li>
                        <strong>Budget:</strong>2.450.000.00KM
                      </li>
                      <li>
                        <strong>Engineer:</strong> Nermin &amp; Meliha
                      </li>
                      <li>
                        <strong>Section:</strong> Vlakovo-Tarčin{" "}
                      </li>
                    </ul>
                  </div>
                </div>
